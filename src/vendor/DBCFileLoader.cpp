// Vendored from AzerothCore src/common/DataStores/DBCFileLoader.cpp (byte-for-byte
// logic unchanged so this tool loads .dbc files exactly as the live server does).
